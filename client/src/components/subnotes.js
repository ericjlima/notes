    ...
    var hidden = {
      display: this.state.hiddenTextarea ? "none" : "block"
        ...
        return(
            <div>
              <div>
                 <Link to={this.props.match.url.substring(0, this.props.match.url.lastIndexOf('/'))}>&lt; Back to {this.props.match.params.id}</Link>
              </div>
              <div className="header">
                <h1>{this.toTitleCase(this.props.match.params.sid)}</h1><br />
              </div>
